...
#ifndef LUAPROJECT_LUAJAVA_H
#define LUAPROJECT_LUAJAVA_H

#define LUASTATE_CLASS "com/slack/luaproject/luajava/LuaState"
#define CPTR_CLASS_PATH "Lcom/slack/luaproject/luajava/CPtr;"
